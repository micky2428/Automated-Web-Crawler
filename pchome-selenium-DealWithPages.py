...
for link in product_links:
    ...
    # 商品描述
    # 使用 find_all 方法找到所有產品介紹的 <li> 元素
    product_intro_tags = product_soup.find_all("li", {"class": "c-blockCombine__item c-blockCombine__item--prodSlogan"})
