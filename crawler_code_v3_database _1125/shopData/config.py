...
MYSQL_DATA_PASSWORD = os.environ.get("MYSQL_DATA_PASSWORD", "bsmi-ks07")
MYSQL_DATA_PORT = int(os.environ.get("MYSQL_DATA_PORT", "3306"))
MYSQL_DATA_DATABASE = os.environ.get("MYSQL_DATA_DATABASE", "shopData")

WORKER_ACCOUNT = os.environ.get("WORKER_ACCOUNT", "bsmiworker")
WORKER_PASSWORD = os.environ.get("WORKER_PASSWORD", "ksbsmi")
